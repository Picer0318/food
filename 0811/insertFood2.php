...
$qurey = "INSERT INTO `food1`(`food_type`, `food_name`, `food_area`, `food_address`, `expiry_date`, `pickup_time`, `detail`, `phone`,`image`) VALUES ('$food_type','$food_name','$food_area','$food_address','$expiry_date','$pickup_time','$detail','$phone','$image')";
